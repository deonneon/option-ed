...
const MODULES_TECH: Module[] = [
    ...
    steps: [
      {
        ...
        math: [
          ...
          { label: "", value: "" },
          { label: "That's it.", value: "No magic. Just trading.", highlight: true }
        ],
        tooltips: [
          { term: "MARKETPLACE", metaphor: "Like eBay for company ownership. Buyers bid, sellers ask, and when they agree on a price, a trade happens." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "BUYER", metaphor: "Like someone at an auction raising their paddle. They believe what they're buying is worth more than the money they're spending." },
          { term: "SELLER", metaphor: "The person holding the item at the auction. They'd rather have cash than keep holding what they own." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "short", metaphor: "Like borrowing your neighbor's lawnmower, selling it at a garage sale, then buying a cheaper one to return. Risky if lawnmower prices go up!" }
        ]
      },
      {
        ...
        tooltips: [
          { term: "CAPITAL GAINS", metaphor: "The difference between what you paid and what you sold for. Like buying a house for $200k and selling it for $250k - that $50k is your capital gain." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "S&P 500", metaphor: "A basket of the 500 biggest US companies. Think of it as buying a tiny slice of Apple, Microsoft, Amazon, Google, and 496 others - all in one purchase." },
          { term: "compound growth", metaphor: "Your gains making more gains. Like a snowball rolling downhill - it starts small but grows faster and faster." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "DIVIDENDS", metaphor: "Like owning a rental property that sends you rent checks, except it's a company sending you a slice of their profits." },
          { term: "Dividend yield", metaphor: "The annual 'interest rate' you earn. A 3% yield means $60 invested pays you $1.80 per year." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "DRIP", metaphor: "Like setting your bank account to auto-invest your interest. You never see the cash, but your pile keeps growing automatically." }
        ],
        prediction: {
          question: "If you reinvest dividends, what happens over time?",
          options: ["You own more shares each year", "Your dividend payments shrink", "Nothing changes"],
          correctIndex: 0,
          explanation: "Reinvesting means your dividends buy more shares. More shares = more dividends next quarter. It compounds over time!"
        }
      },
      {
        ...
        tooltips: [
          { term: "OPTIONS", metaphor: "Like a coupon that locks in today's price. If prices go up, your coupon is valuable. If they don't, you only lose what you paid for the coupon." }
        ]
      },
      {
    ...
    steps: [
      {
        ...
        math: [
          ...
          { label: "", value: "" },
          { label: "No 'right' answer", value: "Just what fits YOU", highlight: true }
        ],
        tooltips: [
          { term: "PASSIVE investors", metaphor: "Like planting an oak tree. You plant it, water it occasionally, and let it grow for decades. Minimal effort, maximum patience." },
          { term: "ACTIVE investors", metaphor: "Like tending a garden. You research which plants to grow, prune regularly, and swap out what's not working." },
          { term: "TRADERS", metaphor: "Like a day at the farmer's market. You're buying and selling constantly, looking for quick opportunities before the day ends." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "index funds", metaphor: "Like buying a sampler platter instead of picking one dish. You get a little bit of everything - if one company fails, others carry the weight." },
          { term: "Set it and forget it", metaphor: "Like a slow cooker. Put your ingredients in, set the timer, and come back hours later to a finished meal. No stirring required." }
        ]
      },
      {
        ...
        math: [
          ...
          { label: "beat S&P 500 over 15 years", value: "~10%", highlight: true },
          { label: "", value: "" },
        ...
        tooltips: [
          { term: "MATH", metaphor: "Every trade has a cost. Like a casino taking a small cut from every pot - even if you're skilled, the house edge adds up over thousands of hands." }
        ]
      },
      {
        ...
        prediction: {
          question: "Why do most professional fund managers fail to beat index funds?",
          options: ["They're not smart enough", "Fees, taxes, and bad timing add up", "Index funds are rigged"],
          correctIndex: 1,
          explanation: "It's not about smarts - it's about costs. Management fees, trading costs, and taxes compound over time. Even small drags of 1-2% per year add up to massive underperformance over decades."
        }
      },
      {
        ...
        tooltips: [
          { term: "ACTIVE Investor", metaphor: "Like being a talent scout. You watch games, study stats, and try to find the next star before everyone else notices." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "EDGE", metaphor: "Your unfair advantage. Like a poker player who can read tells that others miss. Without an edge, you're just gambling." },
          { term: "10-Ks", metaphor: "A company's annual report card filed with the SEC. Boring to read, but full of details that news articles skip over." }
        ]
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "TRADER", metaphor: "Like a surfer catching waves. You don't care where the ocean is going long-term - you just want to ride the next wave and get out before it crashes." },
          { term: "technical analysis", metaphor: "Reading price charts like tea leaves. Traders believe past patterns predict future moves - support levels, resistance, momentum." }
        ]
      },
      {
        ...
        math: [
          ...
          { label: "Option moves 50%", value: "+$500 on $1,000", highlight: true },
          { label: "", value: "" },
          { label: "But also...", value: "" },
          { label: "Stock drops 5%", value: "-$500 on $10,000" },
          { label: "Option drops 50%", value: "-$500 on $1,000", highlight: true },
          { label: "", value: "" },
      ...
      },
      {
        ...
        tooltips: [
          { term: "revenge trading", metaphor: "Like a gambler trying to win back losses by doubling down. It almost always makes things worse. The market doesn't care about your feelings." }
        ]
      },
      {
        ...
        prediction: {
          ...
          options: ["Passive - it's proven to work", "Active - pick winners", "Trading - maximize gains", "Depends on your situation"],
          correctIndex: 3,
          explanation: "There's no universal 'best.' Passive works for most people, but some thrive with active investing or trading. The best approach is one you'll stick with consistently over time."
        }
      },
      {
        ...
        math: [
          ...
          { label: "5% of portfolio", value: "Options (trading)", highlight: true },
          { label: "", value: "" },
        ...
        tooltips: [
          { term: "play money", metaphor: "Casino chips that won't hurt if you lose them. Like going to Vegas with $500 in your pocket - fun to gamble with, but you've already written it off mentally." }
        ]
      }
    ]
  },
  {
    ...
    steps: [
      {
        text: "Welcome to OptionEd. In the next 15 minutes, you'll learn how options trading works through real scenarios. No jargon, no fluff - just the essentials.",
    ...
    steps: [
      ...
      },
      {
        ...
        prediction: {
          ...
          options: ["Yes, I'm above the $210 strike!", "No, I need to hit $220 to profit", "I break even"],
          correctIndex: 1,
          explanation: "Even though $215 is above your $210 strike, you paid $10 for the option. You need $220 ($210 + $10) to actually profit."
        }
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        prediction: {
          ...
          options: ["$50 (the full drop)", "$40 ($50 minus my $10 cost)", "$150 (the stock price)"],
          correctIndex: 1,
          explanation: "Your Put lets you sell at $200 when it's worth $150 = $50 intrinsic value. But you paid $10, so your net profit is $40 per share."
        }
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        prediction: {
          ...
          options: ["I keep the $500, nothing else happens", "I have to buy shares anyway", "I lose the $500"],
          correctIndex: 0,
          explanation: "When you sell a put, you collect premium upfront. If the stock stays ABOVE your strike, the put expires worthless and you keep the premium. That's the best outcome!"
        }
      },
      {
    ...
    steps: [
      {
        ...
        tooltips: [
          { term: "MARKETPLACE", metaphor: "Like Depop or Poshmark for company ownership. Buyers bid, sellers ask, and when they agree on a price, a trade happens." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "BUYER", metaphor: "Like someone at an estate sale raising their paddle. They believe what they're buying is worth more than the money they're spending." },
          { term: "SELLER", metaphor: "The person letting go of the item. They'd rather have cash than keep holding what they own." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "short", metaphor: "Like borrowing your roommate's textbook, selling it online, then buying a cheaper used copy to return. Risky if textbook prices go up!" }
        ]
      },
      {
        ...
        tooltips: [
          { term: "CAPITAL GAINS", metaphor: "The difference between what you paid and what you sold for. Like buying a vintage bag for $200 and selling it for $350 - that $150 is your capital gain." }
        ]
      },
      {
        text: "The math is simple but powerful. Over 30 years, the S&P 500 has returned about 10% per year on average. $10,000 invested in 1994 would be worth over $170,000 today.",
        ...
        tooltips: [
          { term: "S&P 500", metaphor: "A basket of the 500 biggest US companies. Think of it as buying a tiny slice of Starbucks, Apple, Nike, Ulta, and 496 others - all in one purchase." },
          { term: "compound growth", metaphor: "Your gains making more gains. Like a snowball rolling downhill - it starts small but grows faster and faster." }
        ]
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "DRIP", metaphor: "Like setting your savings account to auto-invest your interest. You never see the cash, but your pile keeps growing automatically." }
        ],
        prediction: {
          question: "If you reinvest dividends, what happens over time?",
          options: ["You own more shares each year", "Your dividend payments shrink", "Nothing changes"],
      ...
      },
      {
        ...
        tooltips: [
          { term: "OPTIONS", metaphor: "Like a coupon that locks in today's price. If prices go up, your coupon becomes valuable. If they don't, you only lose what you paid for the coupon." }
        ]
      },
      {
    ...
    steps: [
      {
        ...
        tooltips: [
          { term: "PASSIVE investors", metaphor: "Like planting a garden and letting it grow. You plant it, water it occasionally, and let nature do its thing over years." },
          { term: "ACTIVE investors", metaphor: "Like curating your closet. You research what's worth keeping, donate what's not working, and add pieces strategically." },
          { term: "TRADERS", metaphor: "Like thrifting for resale. You're buying and selling constantly, looking for quick flips before trends change." }
        ]
      },
      {
        text: "TYPE 1: The PASSIVE Investor. 'Set it and forget it.' Buy index funds, reinvest dividends, check your account once a year. Warren Buffett recommends this for most people.",
        ...
        tooltips: [
          { term: "index funds", metaphor: "Like buying a capsule wardrobe instead of picking one item. You get a balanced mix of everything - if one piece goes out of style, others carry the look." },
          { term: "Set it and forget it", metaphor: "Like a crockpot meal. Put your ingredients in, set the timer, and come back hours later to a finished dish. No stirring required." }
        ]
      },
      {
        text: "Passive wins because of MATH. Studies show 90% of professional fund managers FAIL to beat the S&P 500 over 15 years. If pros can't beat the market, why try? Just buy the market.",
        ...
        tooltips: [
          { term: "MATH", metaphor: "Every trade has a cost. Like paying a small fee every time you return something online - even if you're good at shopping, the fees add up over hundreds of orders." }
        ]
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "ACTIVE Investor", metaphor: "Like being a trend forecaster. You watch what's happening, study the data, and try to spot the next big thing before everyone else notices." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "EDGE", metaphor: "Your unfair advantage. Like knowing a restaurant is amazing before it gets discovered on TikTok. Without an edge, you're just guessing." },
          { term: "10-Ks", metaphor: "A company's annual report card filed with the SEC. Dry reading, but full of details that headlines skip over." }
        ]
      },
      {
        text: "The catch? You're competing against hedge funds with PhDs, supercomputers, and insider connections. Most individual stock pickers underperform. But if you love research, this path can be rewarding.",
      ...
      },
      {
        ...
        tooltips: [
          { term: "TRADER", metaphor: "Like catching waves while surfing. You don't care where the ocean is going long-term - you just want to ride the next wave and get out before it crashes." },
          { term: "technical analysis", metaphor: "Reading price charts to predict moves. Traders believe past patterns hint at future moves - support levels, resistance, momentum." }
        ]
      },
      {
        text: "Traders use tools like OPTIONS to amplify moves. A 5% stock move can become a 50% option gain. But it cuts both ways - small losses become big losses fast. This is where discipline matters most.",
      ...
      },
      {
        ...
        tooltips: [
          { term: "revenge trading", metaphor: "Like stress-shopping after a bad day. It feels good in the moment but usually makes things worse. The market doesn't care about your feelings." }
        ]
      },
      {
        text: "Here's a simple framework. Ask yourself: How much TIME do I have? Do I want to BEAT the market or MATCH it? And honestly - do I have the DISCIPLINE to stick to a plan when emotions run hot?",
      ...
      },
      {
        ...
        tooltips: [
          { term: "5% of portfolio", metaphor: "Your 'learning budget.' Like setting aside money for experiences - you might lose it, but you'll gain knowledge either way." }
        ]
      }
    ]
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tooltips: [
          { term: "OPTIONS", metaphor: "Like a reservation deposit: you pay a small fee now for the right to buy later at today's price. If you change your mind, you only lose the deposit." }
        ]
      }
    ]
  },
    ...
    steps: [
      {
        text: "An OPTION is a contract that lets you bet on where a stock will go. A CALL option makes money when the stock goes UP.",
        actionLabel: "Got It",
        setup: { type: 'call', side: 'buy', strike: 420, simPrice: 400, daysLeft: 30 },
        math: [
          { label: "Two types of options", value: "" },
          { label: "", value: "" },
          { label: "CALL", value: "Bet on UP 📈", highlight: true },
        ...
        tooltips: [
          { term: "OPTION", metaphor: "Like a concert ticket: you pay upfront for the right to attend, but you're not forced to go." },
          { term: "CALL option", metaphor: "Like a sale coupon that locks in today's price. If the price goes up, your coupon becomes valuable. If it goes down, you just toss the coupon." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "contract", metaphor: "Like buying a multi-pack: the price tag says $20 per unit, but you're buying a 100-pack. The contract is the whole pack." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "STRIKE price", metaphor: "The price printed on your coupon. Like a gift card that says 'Buy one item for $420' - $420 is the strike. If items cost $460, your card is valuable." },
          { term: "in the money", metaphor: "Your ticket is a winner. The conditions are met, so your contract has real cash value." },
          { term: "expires worthless", metaphor: "Like a coupon you forgot about - once the date passes, it's just paper." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "RIGHT (not obligation)", metaphor: "Like a restaurant reservation: you CAN show up and get your table, but nobody forces you to eat there." },
          { term: "Breakeven", metaphor: "The point where you get your money back. Like driving to a show - you need to enjoy it enough to cover the ticket AND the gas." },
          { term: "$20", metaphor: "The 'premium' - what you pay for the contract itself. This is your max loss if things go wrong." }
        ],
        prediction: {
          question: "If Lululemon goes to $430 at expiration, do you make money?",
          options: ["Yes, I'm above the $420 strike!", "No, I need to hit $440 to profit", "I break even"],
          correctIndex: 1,
          explanation: "Even though $430 is above your $420 strike, you paid $20 for the option. You need $440 ($420 + $20) to actually profit."
        }
      },
      {
        ...
        actionLabel: "See the Payoff",
        setup: { type: 'call', side: 'buy', strike: 420, simPrice: 430, daysLeft: 0 },
        math: [
        ...
        tooltips: [
          { term: "exercise", metaphor: "Using your coupon. Like redeeming a discount code at checkout - you're cashing in your right." },
          { term: "Intrinsic value", metaphor: "The real cash value RIGHT NOW. Like a $50 gift card - it's worth $50, no more, no less." }
        ]
      },
      {
      ...
      },
      {
        ...
        math: [
          ...
          { label: "Profit ($40 × 100 × 20)", value: "+$80,000", highlight: true }
        ]
      },
      {
        ...
        math: [
          ...
          { label: "", value: "" },
          { label: "Options approach", value: "", highlight: true },
          { label: "Options expire worthless", value: "-$40,000", highlight: true },
          { label: "You own nothing", value: "✗" }
        ]
      }
    ]
    ...
    steps: [
      {
        text: "A PUT option is the opposite. It makes money when the stock goes DOWN. Think of it as insurance against a crash.",
        actionLabel: "Got It",
        setup: { type: 'put', side: 'buy', strike: 400, simPrice: 400, daysLeft: 30 },
        math: [
          { label: "CALL option", value: "Profits when UP 📈" },
          { label: "", value: "" },
          { label: "PUT option", value: "Profits when DOWN 📉", highlight: true },
        ...
        tooltips: [
          { term: "PUT option", metaphor: "Like phone insurance: you pay a small premium hoping you'll never need it, but if disaster strikes, it pays out." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "RIGHT to sell", metaphor: "Like a store's return policy: 'We'll buy this back for $400 anytime this month.' You don't need to own the item yet - the guarantee itself has value if prices drop." }
        ]
      },
      {
        ...
        prediction: {
          question: "If Lululemon crashes to $300, what's your profit per share?",
          options: ["$100 (the full drop)", "$80 ($100 minus my $20 cost)", "$300 (the stock price)"],
          correctIndex: 1,
          explanation: "Your Put lets you sell at $400 when it's worth $300 = $100 intrinsic value. But you paid $20, so your net profit is $80 per share."
        }
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "max loss", metaphor: "Like a bad movie ticket - worst case, you wasted $20. The movie can't reach into your wallet and take more." },
          { term: "premium", metaphor: "The price of admission. Like a cover charge - that money's gone whether you have fun or not." }
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        tooltips: [
          { term: "EXPIRE", metaphor: "Like a coupon in your wallet - it has a 'use by' date. After that, it's worthless no matter how good the deal was." }
        ]
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "theta decay", metaphor: "Like a parking meter ticking down. Every minute that passes, you're losing value - even if nothing else changes." },
          { term: "Probability shrinks", metaphor: "Imagine waiting for a text back. With a week to wait, good odds. With 5 minutes left? Not looking good." }
        ]
      },
      {
      ...
      },
      {
        ...
        tooltips: [
          { term: "ACCELERATES", metaphor: "Like ice cream on a hot day. First hour? Slow drip. Last 10 minutes? Melting everywhere." },
          { term: "Theta burn", metaphor: "Watching your value evaporate. The closer you get to expiration, the faster it disappears." }
        ]
      },
      {
    ...
    steps: [
      {
        ...
        tooltips: [
          { term: "SELL options", metaphor: "Like selling insurance policies. Allstate collects premiums every month. Most months, nothing happens and they keep it. But when claims come in, they pay out." },
          { term: "selling insurance", metaphor: "You're the one providing protection. You collect steady income, but you're on the hook if something goes wrong." }
        ]
      },
      {
        text: "When you SELL a Put, someone BUYS it from you. They pay you $5 per share for the insurance. That's $500 (100 shares × $5) in your pocket immediately.",
      ...
      },
      {
        ...
        tooltips: [
          { term: "collateral", metaphor: "Like a security deposit. Your broker holds it to make sure you can fulfill your promise if things go wrong." },
          { term: "assignment", metaphor: "Getting called on your promise. You sold someone insurance, and now they're filing a claim. Time to deliver." },
          { term: "No backing out", metaphor: "You made a binding commitment. The other person is counting on you to honor it." }
        ]
      },
      {
        text: "30 days later, KO is still at $65. The Put expires worthless - why would they force you to buy at $60 when it's worth $65? You keep the $500 free and clear. Collateral is released.",
      ...
      },
      {
        ...
        tooltips: [
          { term: "Risk/Reward ratio", metaphor: "You're risking $5,500 to make $500. The probability of winning better be high enough to justify that imbalance." }
        ]
      },
      {
        ...
        tooltips: [
          { term: "position sizing", metaphor: "Don't put all your eggs in one basket. If you have $50,000, maybe only risk $5,000 on any single position. One bad outcome shouldn't derail you." },
          { term: "80% of options expire worthless", metaphor: "Most insurance policies never get claimed. As the seller, you're collecting premiums that usually just become profit." }
        ]
      },
      {
        text: "Pro tip: only sell puts on stocks you'd be HAPPY to own at that price. If KO drops to $60 and you get assigned, you now own a solid dividend stock at a discount. That's called a 'cash-secured put.'",
        ...
        tooltips: [
          { term: "cash-secured put", metaphor: "Like telling a seller: 'I'll buy that for $6,000 if you pay me $500 to wait.' Either you get $500 free, or you get what you wanted anyway at a discount." },
          { term: "dividend stock", metaphor: "A stock that pays you just for owning it. Like a savings account that sends you interest checks every quarter." }
        ]
      },
      {
