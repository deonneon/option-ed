    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex items-center justify-center p-6">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold tracking-tighter text-neutral-900 mb-4">
            OptionsEd
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="group relative p-6 rounded-xl border-2 border-neutral-200 hover:border-neutral-900 transition-all text-left"
            >
              <div className="absolute top-4 right-4 w-5 h-5 rounded-full border-2 border-neutral-300 group-hover:border-neutral-900 transition-colors" />
